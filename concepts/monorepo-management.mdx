...
<CardGroup cols={3}>
  <Card title="Core" icon="layer-group" href="/reference/core-package">
    Full ERN Stack monorepo with frontend and backend
  </Card>
  <Card title="React" icon="react" href="/reference/react-package">
    Frontend-only architecture with Vite + React
  </Card>
  <Card title="Node" icon="node" href="/reference/node-package">
